        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Raca = table.Column<string>(type: "varchar(50)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Inserted = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    Updated = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cpf = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CRV = table.Column<uint>(type: "int unsigned", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pets_Donos", x => new { x.Id_Dono, x.Id_Pet });
                    table.ForeignKey(
                        name: "FK_Pets_Donos_Dono_Id_Dono",
                        column: x => x.Id_Dono,
                        principalTable: "Dono",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pets_Donos_Pet_Id_Pet",
                        column: x => x.Id_Pet,
                        principalTable: "Pet",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descricao = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Id_Pet = table.Column<int>(type: "int", nullable: false),
                    Id_tipoAtendimento = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Consultas_Dono_Id_Pet",
                        column: x => x.Id_Pet,
                        principalTable: "Dono",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Consultas_Pet_Id_Pet",
                        column: x => x.Id_Pet,
                        principalTable: "Pet",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Consultas_TipoAtendimento_Id_tipoAtendimento",
                        column: x => x.Id_tipoAtendimento,
            ...
            migrationBuilder.CreateTable(
                name: "Profissional_TipoAtendimento",
                columns: table => new
                {
                    Id_profissional = table.Column<int>(type: "int", nullable: false),
                    Id_tipoAtendimento = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Profissional_TipoAtendimento", x => new { x.Id_tipoAtendimento, x.Id_profissional });
                    table.ForeignKey(
                        name: "FK_Profissional_TipoAtendimento_Profissional_Id_profissional",
                        column: x => x.Id_profissional,
                        principalTable: "Profissional",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Profissional_TipoAtendimento_TipoAtendimento_Id_tipoAtendime~",
                        column: x => x.Id_tipoAtendimento,
                        principalTable: "TipoAtendimento",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Consultas_Id_tipoAtendimento",
                table: "Consultas",
                column: "Id_tipoAtendimento");

            migrationBuilder.CreateIndex(
                name: "IX_Pets_Donos_Id_Pet",
                table: "Pets_Donos",
                column: "Id_Pet");

            migrationBuilder.CreateIndex(
                name: "IX_Profissional_TipoAtendimento_Id_profissional",
                table: "Profissional_TipoAtendimento",
                column: "Id_profissional");
        }
